    ...
    <div className="container container--cart">
      <div className="cart">
        ...
        <div className="content__items">
          {chosenPizzas.map((obj, ind, pizzas) => {
            if (uniqPizza.indexOf(JSON.stringify(obj)) === -1) {
              let count = 0;
              for (let i = 0; i < pizzas.length; i++) {
                if (JSON.stringify(obj) === JSON.stringify(pizzas[i])) {
                  count++;
                  uniqPizza.push(JSON.stringify(obj));
                }
              }
              return (
                <CartItem
        ...
        <div className="cart__bottom">
          <div className="cart__bottom-details">
            <span>
              {' '}
              Всего пицц: <b>{totalNumberOfPizzasInCart} шт.</b>{' '}
            </span>
            <span>
              {' '}
